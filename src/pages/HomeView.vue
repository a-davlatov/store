...
<template>
  <div class="container">
    ...
    >
      <swiper-slide>
        <div class="relative h-full flex items-center justify-center">
          <img class="w-full" v-lazy="{ src: './hoodies/main.jpg', loading: './hoodies/main.jpg' }" alt="hoodies">
      ...
      <swiper-slide>
        <div class="relative h-full flex items-center justify-center">
          <img class="w-full" v-lazy="{ src: './sneakers/main.jpg', loading: '/store/preloader_sm.gif' }" alt="sneakers">
      ...
      <swiper-slide>
        <div class="relative h-full flex items-center justify-center">
          <img class="w-full" v-lazy="{ src: './caps/main.jpg', loading: '/store/preloader_sm.gif' }" alt="caps">
      ...
      <swiper-slide>
        <div class="relative h-full flex items-center justify-center">
          <img class="w-full" v-lazy="{ src: './panamas/main.jpg', loading: '/store/preloader_sm.gif' }" alt="panamas">
    ...
    <swiper
      class="swiper-sales mt-3 sm:mt-4 sm:mb-20"
...
.swiper-intro img[lazy="loading"],
.swiper-intro img[lazy="error"] {
  width: auto;
}
